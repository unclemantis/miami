...
Clarinet.test({
    ...
    async fn(chain: Chain, accounts: Map<string, Account>) {
        ...
        let block = chain.mineBlock([
            ...
            Tx.contractCall('proposal-core-v1', 'create-proposal',[types.utf8("Proposal 2"), types.utf8("oyugiyug igu fyrcrexrews biunb uin"), types.utf8("This is only a test"), types.uint(2100)], wallet_1.address),
